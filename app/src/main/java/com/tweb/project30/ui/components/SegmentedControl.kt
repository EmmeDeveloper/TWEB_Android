// Licensed by https://gist.github.com/zach-klippenstein/7ae8874db304f957d6bb91263e292117
...
private var TRACK_COLOR = Color(0xFFE0E0E0)
...
@Composable fun <T : Any> SegmentedControl(
    ...
    TRACK_COLOR = MaterialTheme.colorScheme.primary.copy(alpha = .5f)
